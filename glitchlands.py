...
pygame.init()
try:
    from PygameShader import shader
except ImportError:
    shader = None
...
class AssetLoader:
    ...
    def load(self):  # load main assets
        self.player = Assets.load_spritesheet_dir(
            "player", (32, 32), (64, 64), hflip=True, vflip=True
        )
        self.backgrounds = Assets.load_spritesheet(
            "ui/backgrounds.png", (64, 64), (128, 128), alpha=False
        )
        self.sounds = Assets.load_sound_dir("sounds")
        charset = "ABCDEFGHIJKLMNOPQRSTUVWXYZ  %/0123456789.,:?!()+-'"
        self.font = Assets.load_font("ui/font.png", (10, 12), (20, 24), charset=charset)
        self.font.set_char_widths(0.5, "'")
        self.font_outlined = Assets.load_font(
            "ui/font_outlined.png", (12, 14), (24, 28), charset=charset
        )
        self.font_outlined.set_char_widths(0.5, ":'")
        self.font_small = Assets.load_font("ui/font_small.png", (8, 10), (16, 20))
        self.font_small.set_char_widths(1.1, "MW")
        self.font_small.set_char_widths(0.5, ":'")
        self.font_small.set_char_widths(0.4, " ")

        self.ui = Collection()
        self.ui.add(
            "menu_buttons", Assets.load_spritesheet("ui/menu_buttons.png", (96, 16), (192, 32))
        )
        self.ui.add(
            "menu_buttons_small",
            Assets.load_spritesheet("ui/menu_buttons_small.png", (18, 14), (36, 28)),
        )
        self.ui.add("menu_icons", Assets.load_spritesheet("ui/menu_icons.png", (9, 9), (18, 18)))
        self.ui.add(
            "slot_buttons", Assets.load_spritesheet("ui/slot_buttons.png", (96, 64), (192, 128))
        )
        ...
        self.ui.add(
            "dialogue_container", Assets.load_image("ui/dialogue_container.png", (784, 160))
        )
        self.ui.add(
            "crystal_counter", Assets.load_spritesheet("ui/crystal_counter.png", (24, 16), (48, 32))
        )
        ...
        self.terrain = [  # terrain[type][style][num]
            ...
            Assets.load_terrain(
                terrain_image,
                [(1, 12, 0), (1, 12, 4), (1, 12, 8), (1, 17, 8), (1, 22, 8)],  # beams
                (16, 16),
                (32, 32),
            ),
            Assets.load_terrain(
                terrain_image, [(2, 17, 1), (2, 17, 2), (2, 17, 0)], (16, 16), (32, 32)  # bridges
            ),
            Assets.load_terrain(terrain_image, [(3, 0, 3)], (16, 16), (32, 32)),  # spikes
        ]

        self.objects = Collection()
        self.objects.add(
            "upgrade_stand",
            Assets.load_spritesheet("objects/upgrade_stand.png", (32, 32), (64, 64)),
        )
        self.objects.add(
            "fire_trap",
            Assets.load_spritesheet("objects/fire_trap.png", (16, 32), (32, 64), vflip=True),
        )
        self.objects.add(
            "saw_trap",
            Assets.load_spritesheet("objects/saw_trap.png", (38, 38), (76, 76), hflip=True),
        )
        self.objects.add(
            "crusher", Assets.load_spritesheet("objects/crusher.png", (64, 48), (128, 96))
        )
        self.objects.add(
            "falling_platform",
            Assets.load_spritesheet("objects/falling_platform.png", (32, 16), (64, 32)),
        )
        self.objects.add(
            "one_way_gate",
            Assets.load_spritesheet("objects/one_way_gate.png", (48, 48), (96, 96), hflip=True),
        )
        self.objects.add("goo", Assets.load_image("objects/goo.png", (128, 128)))
        self.objects.add(
            "npc", Assets.load_spritesheet("objects/npc.png", (32, 32), (64, 64), hflip=True)
        )
        self.objects.add(
            "bat", Assets.load_spritesheet("objects/bat.png", (46, 28), (92, 56), hflip=True)
        )
        for name in ("upgrades", "button", "dark_spikes", "rgb_spikes", "glitch_crystal"):
            self.objects.add(
                name, Assets.load_spritesheet(f"objects/{name}.png", (16, 16), (32, 32))
            )

        self.decoration = Collection()
        self.decoration.add(
            "title", Assets.load_spritesheet("decoration/title.png", (256, 64), (512, 128))
        )
        self.decoration.add(
            "credit_top", Assets.load_spritesheet("decoration/credit_top.png", (150, 10), (450, 30))
        )
        self.decoration.add(
            "credit_bottom",
            Assets.load_spritesheet("decoration/credit_bottom.png", (150, 10), (450, 30)),
        )
        self.decoration.add(
            "meteor", Assets.load_spritesheet("decoration/meteor.png", (44, 56), (44 * 2, 56 * 2))
        )
        ...
        self.decoration.add(
            "vines", Assets.load_spritesheet("decoration/vines.png", (48, 48), (96, 96))
        )
        self.decoration.add(
            "signs", Assets.load_spritesheet("decoration/signs.png", (32, 32), (64, 64))
        )
        self.decoration.add(
            "virus_transition", Assets.load_image("virus/transition.png", (800, 480), alpha=False)
        )
    ...
    def load_virus(self):  # load assets only used for the virus bossfight
        ...
        self.virus.add(
            "side", Assets.load_spritesheet("virus/side.png", (116, 96), (464, 384), hflip=True)
        )
        ...
        self.virus.add(
            "tentacle_drill",
            Assets.load_spritesheet("virus/tentacle_drill.png", (32, 32), (64, 64), vflip=True),
        )
        self.virus.add(
            "hit_button", Assets.load_spritesheet("virus/hit_button.png", (32, 16), (64, 32))
        )
        self.virus.add(
            "infection",
            Assets.load_spritesheet("virus/infection.png", (32, 16), (64, 32), hflip=True),
        )
        self.virus.add(
            "crystal_barrier",
            Assets.load_spritesheet("virus/crystal_barrier.png", (32, 16), (64, 32)),
        )
        self.virus.add(
            "arena_barrier", Assets.load_spritesheet("virus/arena_barrier.png", (32, 16), (64, 32))
        )
        self.virus.add(
            "tombstone", Assets.load_spritesheet("virus/tombstone.png", (32, 48), (64, 96))
        )
    ...
    def save_slot_image(self, slot, fn):
        if fn is not None and os.path.isfile(fn):
            ...
            save_data = None
        im = self.ui["slot_buttons"][
            0 if save_data is None else save_data.get("difficulty", 0) + 1
        ].copy()
        cx = im.get_width() // 2
        if slot >= 0:
        ...
        if save_data is not None:
            ...
            if save_data.get("completed_time") is not None:
                icon = (
                    4
                    if save_data["completed_time"] == GlobalSave.best_time
                    and GlobalSave.speedrun_mode
                    else 5
                )
            if icon is not None:
                im.blit(self.ui.get("menu_icons")[icon], (im.get_width() - 10 - 18, 10))
            text = self.font_small.render(
                ["Rookie", "Normal", "Master"][save_data.get("difficulty", 0)]
            )
            im.blit(text, (cx - text.get_width() // 2, 42))
            if GlobalSave.speedrun_mode and save_data.get("completed_time") is not None:
                t = save_data["completed_time"]
            else:
                t = save_data.get("elapsed_time", 0)
            hours, rem = divmod(t, 3600)
            minutes, seconds = divmod(rem, 60)
            text = self.font_small.render(
                "{:0>2}:{:0>2}:{:0>2}".format(int(hours), int(minutes), math.ceil(seconds))
            )
    ...
    def shield_static(self, sheet, copies=1, min_alpha=0, max_alpha=128):
        out = Spritesheet(
            sheet.width * copies, sheet.height * copies, hflip=sheet.hflip, vflip=sheet.vflip
        )
                ...
                for x in range(0, surface.get_width(), 2):
                    for y in range(0, surface.get_height(), 2):
                        if surface.get_at((x, y)) == (69, 69, 69, 255):
                            pygame.draw.rect(
                                surface,
                                (255, 255, 255, random.randint(min_alpha, max_alpha)),
                                (x, y, 2, 2),
                            )
                out.add(surface)
        return out
...
class GameController(GameControllerBase):
    def __init__(self):
        ...
        for drive in ("U",):
            if os.path.exists(drive + ":\\"):
                self.save_base = drive + ":\\glitchlands_save"
        ...
        self.shown_settings = []
        if not RASPBERRY_PI:
            self.shown_settings.append("windowed")
        self.shown_settings.extend(["show_fps", "show_hitboxes"])
        if PYGAME_2:
            self.shown_settings.append("vsync")
    ...
    def init_level(self, begin=True):
        ...
        self.checkpoint = Checkpoint(
            self.level.level_pos, left=self.player.x, bottom=self.player.y + self.player.recth
        )
        self.npc_dialogue = DialogueState()
        self.xscroll, self.xscroll_target = 0, 0
        self.scroll_bounds = int(self.game_width * 0.51)
    ...
    def restore_progress(self):
        ...
        self.splits = [
            (split[0], split[1], self.format_elapsed(split[1]))
            for split in save_data.get("splits", [])
        ]
    ...
    def restore_checkpoint(self, cp=None, initial=False):
        ...
        if self.level.level_pos != cp.level_pos or initial:
            if (
                self.level.level_pos[0] == cp.level_pos[0]
                and self.level.level_pos[2] == cp.level_pos[2]
            ):
            ...
            self.load_music()
        self.player.reset()
        self.player.move_hitbox(
            left=cp.left, right=cp.right, top=cp.top, bottom=cp.bottom, centerx=cp.centerx
        )
        if initial:
            self.player.facing_right = cp.facing_right
        self.player.revive()
        self.player.update_hitbox()
        self.push_particle(
            particles.AnimatedParticle(self, "spawn", self.player.hitbox.center, anim_delay=3)
        )
        self.background.change_to(self.level.background, change_dir=False)
        if not self.scroll_right and self.xscroll > 0:
            self.xscroll = 0
        elif not self.scroll_left and self.xscroll < 0:
            self.xscroll = 0
    ...
    def skip_intro(self):
        ...
        self.checkpoint = Checkpoint(
            (1, 0, 0), centerx=self.game_width // 2, top=0, facing_right=False
        )
        self.restore_checkpoint(initial=True)
    ...
    def load_level_bottom(self):
        if self.level.level_pos_bottom is not None and self.level.exists(
            self.level.level_pos_bottom
        ):
    ...
    def get_elapsed_time(self):
        if self.selection.menu != MENU_IN_GAME:
    ...
    def format_elapsed(self, elapsed):
        ...
        formatted = "{:0>2}:{:0>2}.{:0>2}".format(
            int(minutes), int(seconds), math.ceil(milliseconds * 100)
        )
        if hours > 0:
            formatted = "{:0>2}:".format(int(hours)) + formatted
        return formatted
    ...
    def enable_pause(self, menu=MENU_PAUSED):
        ...
        self.set_menu(menu)
        if menu in (MENU_PAUSED, MENU_MAP):
    ...
    def set_menu(self, menu, submenu=0, idx=(0, 0)):
        ...
        if not self.in_game and menu == MENU_MAIN:
            ...
            nums = [10, 2, 11]
            if (
                GlobalSave.unlock_master
                and self.level.level_pos[0] == 0
                and all(pos[0] == 0 for pos in self.visited_levels)
            ):
                nums.insert(-1, 12)
            ...
            if submenu in (SUBMENU_SLOT_SELECT, SUBMENU_COPY_SLOT):
                ...
                for i, num in enumerate(nums):
                    ...
                    ui.create_button(
                        ...
                        im,
                        (i, 0),
                        cx=self.game_width // 2 + (-(len(nums) - 1) / 2 + i) * 198,
                        cy=250,
                    )
                ui.create_button(
                    self, buttons[1], [(0, 1), (1, 1)], cx=self.game_width // 2 - 99, cy=370
                )
                ui.create_button(
                    self,
                    buttons[19 if self.save_slot < 4 else 18],
                    [(2, 1), (3, 1)],
                    cx=self.game_width // 2 + 99,
                    cy=370,
                )
                mx = [len(nums), 2]
                ...
                ui.create_graphic(
                    self, self.assets.save_slot_image(self.save_slot, self.get_save_file())
                )
            ...
            ui.create_slider(
                ...
                "volume_sfx",
                1 if RASPBERRY_PI else 0.5,
                [(1, i + 3) for i in range(len(self.shown_settings) - 4)],
                cx=x,
                cy=295,
            )
            ui.create_button(self, buttons[1], [(1, len(self.shown_settings) - 1)], cx=x, cy=390)
            ...
            if menu == MENU_CREDITS:
                ...
                text.rect.top = 700
                ui.create_graphic(
                    self, self.assets.player.get("walk").sprites_hflip, cx=700, cy=850, anim_delay=6
                )
                ui.create_graphic(self, self.assets.objects.get("crusher")[0], cx=100, cy=1300)
                ui.create_graphic(
                    self, self.assets.objects.get("fire_trap")[:3], cx=700, cy=1700, anim_delay=6
                )
                scrollable = True
            else:
                ...
                text += " difficulty.\n\nTime: "
                text += "{:0>2}:{:0>2}:{:0>2}:{:0>2}".format(
                    int(hours), int(minutes), int(seconds), math.ceil(milliseconds * 100)
                )
                text += f"  Deaths: {self.death_count}\n\n"
                if submenu == SUBMENU_UNLOCK_MASTER:
                    text += "Master difficulty has\nbeen unlocked"
                elif submenu == SUBMENU_UNLOCK_SPEEDRUN:
                    text += "Speedrun mode has been\nunlocked"
                elif submenu == SUBMENU_UNLOCK_MASTER_SPEEDRUN:
                    text += "Master difficulty and\n speedrun mode have been\nunlocked"
                elif submenu == SUBMENU_BEST_TIME:
            ...
            for world, world_data in enumerate(self.assets.map.get("data")):
                for pos_string, tile_data in world_data.get("levels", {}).items():
                    ...
                    if pos not in visited and pos != self.level.level_pos:
                        continue
                    visited_levels += 1
                    icon_key = {
                        "upgrade": 2,
                    ...
                    if pos == self.level.level_pos:
                        color = self.background.num
                    elif color == -1:
                        color = random.randint(0, 6)
                    elif color == -2:
                        color = random.randint(7, 13)
                    elif color == -3:
                        color = random.randint(0, 13)
                    fill = color_key[color]
                    if color in (7, 8, 9, 10, 11, 12, 13, 15):
                        stroke = tuple(int(n * 1.3) for n in fill)
                    else:
                        stroke = tuple(int(n * 0.8) for n in fill)
                    ...
                    border_w, border_h = (
                        math.ceil((level_size[0] - 4) / 3),
                        math.ceil((level_size[1] - 4) / 3),
                    )
                    level_left = (
                        tuple(tile_data["left"])
                        if "left" in tile_data
                        else (pos[0], pos[1] - 1, pos[2])
                    )
                    level_top = (
                        tuple(tile_data["top"])
                        if "top" in tile_data
                        else (pos[0], pos[1], pos[2] - 1)
                    )
                    level_right = (
                        tuple(tile_data["right"])
                        if "right" in tile_data
                        else (pos[0], pos[1] + 1, pos[2])
                    )
                    level_bottom = (
                        tuple(tile_data["bottom"])
                        if "bottom" in tile_data
                        else (pos[0], pos[1], pos[2] + 1)
                    )
                    if level_left in visited:
                        if 0 in borders:
                            pygame.draw.rect(
                                surface, fill, (0, level_size[1] - 2 - border_h, 3, border_h)
                            )
                        if 1 in borders:
                            pygame.draw.rect(
                                surface, fill, (0, level_size[1] // 2 - border_h // 2, 3, border_h)
                            )
                        if 2 in borders:
                    ...
                    if level_top in visited:
                        ...
                        if 4 in borders:
                            pygame.draw.rect(
                                surface, fill, (level_size[0] // 2 - border_w // 2, 0, border_w, 3)
                            )
                        if 5 in borders:
                            pygame.draw.rect(
                                surface, fill, (level_size[0] - 2 - border_w, 0, border_w, 3)
                            )
                    if level_right in visited:
                        ...
                        if 8 in borders:
                            pygame.draw.rect(
                                surface,
                                fill,
                                (level_size[0] - 3, level_size[1] - 2 - border_h, 3, border_h),
                            )
                    if level_bottom in visited:
                        if 9 in borders:
                            pygame.draw.rect(
                                surface,
                                fill,
                                (level_size[0] - 2 - border_w, level_size[1] - 3, border_w, 3),
                            )
                        if 10 in borders:
                            pygame.draw.rect(
                                surface,
                    ...
                    cy = (pos[2] + world_data.get("yofs", 0)) * level_size[
                        1
                    ] + self.game_height // 2
                    ui.create_graphic(self, surface, cx=cx, cy=cy)
                    if tile_data.get("icon_name") and (
                        tile_data.get("icon_hide_level") is None
                        or tuple(tile_data["icon_hide_level"]) not in visited
                    ):  # level icon
                        icon_pos = tile_data.get("icon_pos", [0, 0])
                        icon_x, icon_y = cx + icon_pos[0] * (level_size[0] // 3), cy + icon_pos[
                            1
                        ] * (level_size[1] // 4)
                        ...
                        if tile_data.get("warp_target"):
                            ...
                            if target_pos in visited or target_pos == self.level.level_pos:
                                ...
                                target_cx = (
                                    target_pos[1] + target_world_data.get("xofs", 0)
                                ) * level_size[0] + self.game_width // 2
                                target_cy = (
                                    target_pos[2] + target_world_data.get("yofs", 0)
                                ) * level_size[1] + self.game_height // 2
                                target_tile_data = target_world_data.get("levels", {}).get(
                                    ",".join([str(n) for n in target_pos[1:]]), {}
                                )
                    ...
                    if pos == self.level.level_pos:  # player icon
                        level_icons.insert(
                            ...
                            (
                                ...
                                cx
                                + (self.player.x + self.player.rectw // 2 - self.game_width // 2)
                                / self.game_width
                                * (level_size[0] - 30),
                                cy
                                + (self.player.y + self.player.recth // 2 - self.game_height // 2)
                                / self.game_height
                                * (level_size[1] - 30),
                            ),
                        )
            ...
            y = 24
            graphic = ui.create_graphic(
                self,
                self.assets.ui["key_icons"][1 if RASPBERRY_PI else 0],
                cx=24,
                cy=self.game_height - y,
            )
            ...
            if self.crystal_count > 0:  # crystal count
                graphic = ui.create_graphic(
                    self, self.assets.ui.get("crystal_counter")[1], cx=34, cy=self.game_height - y
                )
                graphic.fixed = graphic.hide_ok = True
                if self.completed_time is not None:
                    total = self.max_crystal_count
                else:
                    total = self.crystal_requirements[self.difficulty]
                text = ui.create_text(
                    self, f"{self.crystal_count}/{total}", cy=self.game_height - y
                )
                text.rect.left = 48
                text.fixed = text.hide_ok = True
                y += 38
            if self.completed_time is not None:  # map completion
                graphic = ui.create_graphic(
                    self, self.assets.ui.get("crystal_counter")[2], cx=34, cy=self.game_height - y
                )
                graphic.fixed = graphic.hide_ok = True
                text = ui.create_text(
                    self,
                    str(math.floor(visited_levels / total_levels * 100)) + "%",
                    cy=self.game_height - y,
                )
                text.rect.left = 48
                text.fixed = text.hide_ok = True
    ...
    def launch_selection(self):
        ...
        if not self.in_game and sel.menu == MENU_MAIN:
            if sel.y == 0:
                ...
                self.set_menu(MENU_CREDITS, SUBMENU_SKIP_CREDITS)
            elif sel.y == 3:
                self.running = False
                sound = None
            elif sel.y == 4:
            ...
            if sel.submenu == SUBMENU_SLOT_SELECT:
                if sel.y == 0:  # select slot
                    ...
                    self.set_menu(
                        ...
                        (
                            ...
                            else SUBMENU_DIFFICULTY_SELECT
                        ),
                    )
                ...
                if sel.idx == (0, 1):  # back
                    ...
                    if sel.x == 0:
                        self.difficulty = 0  # rookie
                    elif sel.y == 0:
                        self.difficulty = 1  # normal
                    elif GlobalSave.unlock_master:
                        self.difficulty = 2  # master (if unlocked)
                    else:
                        return  # locked
                    self.should_toggle_in_game = True
                    reset_transition = False
    ...
    def update_cursor_selection(self, just_pressed=False, touch_pos=None):
        if self.in_game and self.selection.menu == 0:
            return
        ...
        for button in self.ui_objects:
            if (
                isinstance(button, ui.Button)
                and len(button.indexes) > 0
                and button.rect.inflate(button.hit_inflate).collidepoint(x, y)
            ):
    ...
    def update(self):
        ...
        if self.in_game and self.selection.menu == MENU_IN_GAME:
            ...
            if (
                not Settings.low_detail
                and self.glitch_chance >= 0
                and random.randint(0, self.glitch_chance // 40) == 0
            ):
                if random.randint(0, len(self.get_block_objects())) == 0:
                    ...
                    if isinstance(block, objects.Block):
                        block.generate_glitch_image()
            ...
            if self.xscroll != self.xscroll_target:
                if self.frame == 0:
                    ...
                    self.xscroll = self.ease_to(self.xscroll, self.xscroll_target, 8)
            if not self.selection.button_pressed:
                if Input.escape or Input.start:
                    ...
                    if (
                        self.npc_dialogue.change_frame > 0
                        and self.npc_dialogue.current.crystals == 0
                    ):
                    ...
                    Input.select
                    and self.player.abilities.map
                    and self.player.teleporter_warp is None
                ):
            ...
            self.selection.button_pressed = any(
                [
                    ...
                    Input.select,
                    Input.secondary,
                    Input.primary and self.npc_dialogue.shown,
                ]
            )
        else:
                ...
                if Input.escape or Input.secondary:
                    if self.in_game:
                        ...
                        if self.selection.menu == MENU_MAIN:
                            ...
                            self.selection.menu == MENU_SLOT_SELECT
                            and self.selection.submenu != SUBMENU_SLOT_SELECT
                        ):
                            if self.selection.submenu == SUBMENU_COPY_SLOT:
                                idx = self.selection.idx
                            else:
                                idx = (self.save_slot % 4, 0)
                            ...
                            self.play_sound("return")
                if Input.x:
                    if self.selection.menu == MENU_SLOT_SELECT and self.selection.submenu in (
                        SUBMENU_SLOT_SELECT,
                        SUBMENU_COPY_SLOT,
                    ):
                        self.save_slot = (self.save_slot + 4) % 8
                        self.set_menu(
                            self.selection.menu, self.selection.submenu, self.selection.idx
                        )
            ...
            if Input.any_direction and not self.selection.scrollable:
                ...
                if perf - self.selection.direction_time_y > prev_delay:
                    ...
                    if Input.up:
                        ...
                        self.selection.direction_time_y = perf
                        self.selection.direction_delay = 0.2
                if prev_selection != self.selection.idx:
                    self.play_sound("hover")
            else:
    ...
    def draw_overlays(self):
        ...
        if Settings.enable_shaders:
            if (
                not self.in_game
                or self.glitch_chance <= 0
                or random.randint(0, self.glitch_chance) // 2 > 0
            ):
                if self.in_game and self.selection.menu == MENU_IN_GAME:
                    cx, cy = self.game_width // 2, self.player.y + self.player.recth // 2
                    amount = (
                        (4000 - self.glitch_chance) / 250000 if self.glitch_chance > 0 else 0.008
                    )
                ...
                self.screen = shader.chromatic(
                    self.screen,
                    min(max(cx, 0), self.game_width),
                    min(max(cy, 0), self.game_height),
                    0.9999,
                    fx=amount,
                )
            ...
            if self.npc_dialogue.shown and self.npc_dialogue.current.content is not None:
                ...
                self.screen.blit(
                    ...
                    (
                        ...
                        self.game_height
                        - 80
                        - content.get_height() // 2
                        - max(4 - self.npc_dialogue.change_frame, 0),
                    ),
                )
        ...
        if GlobalSave.speedrun_mode and self.in_game:
            text = Assets.debug_font.render(
                self.format_elapsed(self.get_elapsed_time()), False, WHITE
            )
            overlays.append((text, (3, y + 2)))
            y += 16
        ...
        if (
            RASPBERRY_PI
            and not (self.in_game and self.selection.menu == MENU_IN_GAME)
            and not self.selection.menu == MENU_MAP
        ):
            indicator = Assets.status_indicator()
            overlays.append((indicator, (0, self.game_height - indicator.get_height())))
    ...
    def push_object(self, *objs):
        for obj in objs:
            if isinstance(obj, objects.GlitchZone):
                if obj.num == 0:
                    self.objects_collide.append(obj)
                else:
                    self.glitch_zones.append(obj)
            elif obj.collides != COLLISION_NONE:
                self.objects_collide.append(obj)
            elif isinstance(obj, objects.Block):
                self.objects_nocollide.append(obj)
            elif obj.layer > 0:
                self.foreground_deco.append(obj)
            else:
                self.background_deco.append(obj)

    def sort_hazards(self):
        def sort(a, b):
            if a.collides in (COLLISION_HAZARD, COLLISION_SHIELDBREAK):
                return 1
            if b.collides in (COLLISION_HAZARD, COLLISION_SHIELDBREAK):
                return -1
            return 0

        self.objects_collide.sort(
            key=cmp_to_key(sort)
        )  # ensure terrain collision takes priority over spikes
    ...
    def create_level(self, level, screen_xofs=None, hflip=False):
        if level is None:
            return
        if screen_xofs is None:
            screen_xofs = level.level_pos[1] - self.level.level_pos[1]
        for config in level.objects:
            removal_range = config.get("removal_range", (None, None))
            if removal_range[0] is not None and self.difficulty >= removal_range[0]:
                continue
            if removal_range[1] is not None and self.difficulty <= removal_range[1]:
                continue
            if hflip:
            ...
            obj = objects.create_object(
                self, level, config, screen_xofs=screen_xofs * self.game_width
            )
    ...
    def create_levels_auto(self, clear=False, xscroll=False):
        ...
        elif xscroll and self.xscroll_target < 0:
            self.xscroll = 0
    ...
    def show_transition(self, level=None, num=None):
        if level is None and self.level is not None:
            level = self.level
        if num is None:
            num = level.transition
        if num == 0:
            ...
            self.transition = FullscreenOverlay(
                self,
                (0, 40, 20),
                color=(68, 68, 68),
                surface=self.assets.decoration.get("virus_transition"),
                shake=4,
            )
    ...
    def show_transition_once(self, level=None):
        if level is None:
            level = self.level
        if level.transition is None or level.level_pos in self.visited_levels:
            return False
        if self.transition is None or (
            self.transition.halfway and self.transition.level_pos != level.level_pos
        ):
    ...
    def append_visited(self, next_pos=None, only_next=False):
        ...
        if next_pos is not None:
            if next_pos[0] <= 0:
                self.assets.load_virus()
            else:
                self.assets.unload_virus()
    ...
    def warp_left(self):
        ...
        if level_loaded:
            ...
            if Settings.reduce_motion:
                self.player.move_hitbox(right=self.game_width)
            else:
                self.player.move_hitbox(centerx=self.game_width - 1)
        ...
        if self.level.checkpoint_positions[2] is not None:
            ...
            prev = (
                prev[0]
                + (self.checkpoint.level_pos[1] - self.level.level_pos[1]) * self.game_width,
                prev[1],
            )
            ok = self.set_checkpoint(
                bottom=self.level.checkpoint_positions[2], right=self.game_width
            )
            if ok and self.checkpoint.get_any_pos() != prev:
                self.player.spawn_particles_checkpoint(
                    center=(self.game_width, self.checkpoint.bottom)
                )

    def warp_right(self):
        if self.level_right is None:
            return
        ...
        if level_loaded:
            ...
            self.delete_all_objects()
            if Settings.reduce_motion:
                self.player.move_hitbox(left=0)
            else:
                self.player.move_hitbox(centerx=1)
    ...
    def warp_bottom(self):
        ...
        if self.level.checkpoint_positions[1] is not None:
            ...
            if ok and self.checkpoint.get_set_sides() != prev:
                self.player.spawn_particles_checkpoint(
                    center=(self.player.x + self.player.rectw // 2, self.player.hitbox.height)
                )

    def warp_top(self):
        if self.level_top is None:
            return
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-s", "--slot", type=int, help="Automatically start with the specified slot index"
    )
